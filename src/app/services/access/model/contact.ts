...
export interface Contact { 
    ...
    id?: string;
    /**
     * The optional contacts first given name.
     */
    firstName?: string;
    /**
     * The optional contacts last given name.
     */
    lastName?: string;
    /**
     * The optional contacts company name.
     */
    company?: string;
    /**
     * A map defining a custom collection of KVP where the key can be any custom definer (default values include; home, work, mobile, main, home fax, work fax, pager) and the value is the actual number.
     */
    phones?: any;
    /**
     * A map defining a custom collection of KVP where the key can be any custom definer (default values include; home, work) and the value is the actual email.
     */
    emails?: any;
    /**
     * A map defining a custom collection of KVP where the key can be any custom definer (default values include; home, work, homepage) and the value is the actual urlr.
     */
    urls?: any;
    /**
     * A map defining a custom collection of KVP where the key can be any custom definer (default values include; home, work) and the value is the actual address.
     */
    addresses?: any;
}
