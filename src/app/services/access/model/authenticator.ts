...
export interface Authenticator { 
    ...
    id?: string;
    /**
     * A simple name to help identify the authenticator within its operational context.
     */
    name?: string;
    /**
     * A short descriptive field to help identify the authenticator within its operational context.
     */
    description?: string;
    /**
     * The ID of the authenticator type that this authenticator uses.
     */
    typeId?: string;
    /**
     * The ID of the vault containing the secret information for the authenticator.
     */
    vaultId?: string;
}
