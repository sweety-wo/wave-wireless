...
export interface Group { 
    ...
    id?: string;
    /**
     * A simple name to help identify the group within its operational context.
     */
    name?: string;
    /**
     * A short descriptive field to help identify the group within its operational context.
     */
    description?: string;
    /**
     * A collection of the role ids associated with the group.
     */
