...
export interface BatchResponse { 
    /**
     * The original batch request object that was executed.
     */
    request?: BatchRequest;
    /**
     * The HTTP status code of the response from the original request.
     */
    statusCode?: number;
    /**
     * A map of string HTTP headers that where returned in the original request response.
     */
    headers?: any;
    /**
     * The optional body returned in the original request response
     */
    body?: any;
}
