...
export interface Role { 
    ...
    id?: string;
    /**
     * A simple name to help identify the role within its operational context.
     */
    name?: string;
    /**
     * A short descriptive field to help identify the role within its operational context. 
     */
    description?: string;
    /**
     * A collection of statements defining the logic and privileges associated with this role.
     */
