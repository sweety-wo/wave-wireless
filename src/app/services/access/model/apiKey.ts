...
export interface ApiKey { 
    /**
     * A unique identifier. This is generated by the system at creation and cannot be specified. This also acts as the public half of the asymmetric key.
     */
    id?: string;
    /**
     * The private key used in combination with the id (public key) to perform asymmetric digest signatures.
     */
    privateKey?: string;
    /**
     * The operational state of the key pair. This can be `ACTIVE` or `INACTIVE`.
     */
    state?: string;
}
