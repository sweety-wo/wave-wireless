...
export interface Federation { 
    ...
    id?: string;
    /**
     * A simple alias to help identify the federation within its operational context. If none is specified the federations reciprocating account id is used.
     */
    alias?: string;
    /**
     * A short descriptive field to help identify the federation within its operational context.
     */
    description?: string;
    /**
     * This value is automatically supplied by the system. It can be `INBOUND`; this is the account that created the federation and indicates that it is granting access into their account. Or `OUTBOUND`; this is the recipient account and indicates that it is being granted access into another account.
     */
    type?: string;
    /**
     * A collection of the role ids associated with the federation. These are only provided for `INBOUND` federations. `OUTBOUND` federations can neither see or manipulate these.
     */
    roleIds?: Array<string>;
    /**
     * A collection of the group ids associated with the federation. These are only provided for `INBOUND` federations. `OUTBOUND` federations can neither see or manipulate these.
     */
