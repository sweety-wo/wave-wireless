...
export interface AuthenticatorType { 
    ...
    id?: string;
    /**
     * A simple name to help identify the authenticator type within its operational context.
     */
    name?: string;
    /**
     * A short descriptive field to help identify the authenticator type within its operational context.
     */
    description?: string;
    /**
     * The form that will need to be filled out by the user durring an authentication request.
     */
    form?: Form;
    /**
     * The KVP defining the values that must be included in the vault.
     */
    securities?: any;
}
