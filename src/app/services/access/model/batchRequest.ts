...
export interface BatchRequest { 
    /**
     * An optional but recommended id value to be able to match the response in the response collection to the original request. If one is not provided a random one will be generated and appended to the response.
     */
    id?: string;
    /**
     * The HTTP method associated with the request. Values can be `GET`, `PATCH`, `PUT`, `POST`, `DELETE`, `CONNECT`, `HEAD`, `TRACE` or `OPTIONS`
     */
    method?: string;
    /**
     * The full path of the request starting with forward slash (/). e.g. /users
     */
    path?: string;
    /**
     * An optional map of query parameter values to pass as part of the request.
     */
    _queryParameters?: any;
    /**
     * Any object that the request body is expecting.
     */
    body?: any;
}
