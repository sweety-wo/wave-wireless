...
export interface Vault { 
    ...
    id?: string;
    /**
     * A simple name to help identify the vault within its operational context.
     */
    name?: string;
    /**
     * A short descriptive field to help identify the vault within its operational context.
     */
    description?: string;
    /**
     * Any serializable model that should be encrypted inside the vault. This field must be supplied at creation and will subsequently never be returned.
     */
    content?: any;
}
