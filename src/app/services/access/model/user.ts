...
export interface User { 
    ...
    id?: string;
    /**
     * A unique email assigned to a user for security and identification.
     */
    email?: string;
    /**
     * A unique username assigned to a user for identification.
     */
    username?: string;
    /**
    ...
    name?: string;
    /**
     * The operational state of an account. This value can be 'ACTIVE', 'SUSPENDED' or 'UNCONFIRMED'.
     */
    state?: string;
    /**
    ...
    data?: Data;
    /**
     * A collection of the role ids associated with the user.
     */
    roleIds?: Array<string>;
    /**
     * A collection of the group ids associated with the user.
     */
    ...
    bio?: string;
    /**
     * The ID of the authenticator assigned to this user. If none is assigned this value may not exist and the user will be assigned to the default authenticator.
     */
