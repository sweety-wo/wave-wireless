...
export class SecurityService {
  ...
  /**
   * create_session
   * Create a session between the client and the server.
   ...
   * @param body This must be the map parameters object obtained from the &#x60;get_authentication_parameters&#x60; function with all the completed values.
   ...
   */
  public createSession(type: string, identifier: string, body: any, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Session>;
  public createSession(type: string, identifier: string, body: any, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Session>>;
  public createSession(type: string, identifier: string, body: any, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Session>>;
  public createSession(type: string, identifier: string, body: any, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (type === null || type === undefined) {
      throw new Error('Required parameter type was null or undefined when calling createSession.');
    }

    if (identifier === null || identifier === undefined) {
      throw new Error('Required parameter identifier was null or undefined when calling createSession.');
    }
    ...
    return this.httpClient.post<Session>(`${this.basePath}/sessions`,
      body,
      {
   ...
   * @param token The unique token that was supplied as part of the registration process.
   * @param body
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public validate(token: string, body: Validation, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
  public validate(token: string, body: Validation, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
  public validate(token: string, body: Validation, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
  public validate(token: string, body: Validation, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (token === null || token === undefined) {
      throw new Error('Required parameter token was null or undefined when calling validate.');
    }
    ...
    return this.httpClient.put<any>(`${this.basePath}/validations`,
      body,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
