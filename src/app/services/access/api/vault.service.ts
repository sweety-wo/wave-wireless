...
export class VaultService {
   ...
   */
  public createVault(authorization: string, body: Vault, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Vault>;
  public createVault(authorization: string, body: Vault, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Vault>>;
  public createVault(authorization: string, body: Vault, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Vault>>;
  public createVault(authorization: string, body: Vault, xPreApiFederation?: string, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling createVault.');
    }

    if (body === null || body === undefined) {
      throw new Error('Required parameter body was null or undefined when calling createVault.');
    }
    ...
    return this.httpClient.post<Vault>(`${this.basePath}/vaults`,
      body,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Vault>;
  public deleteVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Vault>>;
  public deleteVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Vault>>;
  public deleteVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling deleteVault.');
    }

    if (vaultId === null || vaultId === undefined) {
      throw new Error('Required parameter vaultId was null or undefined when calling deleteVault.');
    }
    ...
    return this.httpClient.delete<Vault>(`${this.basePath}/vaults/${encodeURIComponent(String(vaultId))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'body', reportProgress?: boolean): Observable<Vault>;
  public getVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Vault>>;
  public getVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Vault>>;
  public getVault(authorization: string, vaultId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getVault.');
    }

    if (vaultId === null || vaultId === undefined) {
      throw new Error('Required parameter vaultId was null or undefined when calling getVault.');
    }
    ...
    return this.httpClient.get<Vault>(`${this.basePath}/vaults/${encodeURIComponent(String(vaultId))}`,
      {
  ...
  /**
   * get_vaults
   * Retrieve a collection of vaults.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getVaults(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Vault>>;
  public getVaults(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Vault>>>;
  public getVaults(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Vault>>>;
  public getVaults(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getVaults.');
    }
    ...
    return this.httpClient.get<Array<Vault>>(`${this.basePath}/vaults`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
