...
import {AuthenticatorType} from '../model/authenticatorType';
...
export class AuthenticatorService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public createAuthenticator(authorization: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Authenticator>;
  public createAuthenticator(authorization: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Authenticator>>;
  public createAuthenticator(authorization: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Authenticator>>;
  public createAuthenticator(authorization: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling createAuthenticator.');
    }

    if (body === null || body === undefined) {
      throw new Error('Required parameter body was null or undefined when calling createAuthenticator.');
    }
    ...
    return this.httpClient.post<Authenticator>(`${this.basePath}/authenticators`,
      body,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * Delete a authenticator. All users will be returned to the default authentication realm using their account password.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param authenticatorId The id of the authenticator.
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Authenticator>;
  public deleteAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Authenticator>>;
  public deleteAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Authenticator>>;
  public deleteAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling deleteAuthenticator.');
    }

    if (authenticatorId === null || authenticatorId === undefined) {
      throw new Error('Required parameter authenticatorId was null or undefined when calling deleteAuthenticator.');
    }
    ...
    return this.httpClient.delete<Authenticator>(`${this.basePath}/authenticators/${encodeURIComponent(String(authenticatorId))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  /**
   * get_authenticator
   * Retrieve a specific authenticator by its id.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param authenticatorId The id of the authenticator.
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'body', reportProgress?: boolean): Observable<Authenticator>;
  public getAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Authenticator>>;
  public getAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Authenticator>>;
  public getAuthenticator(authorization: string, authenticatorId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getAuthenticator.');
    }
    ...
    return this.httpClient.get<Authenticator>(`${this.basePath}/authenticators/${encodeURIComponent(String(authenticatorId))}`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * Retrieve a specific authenticator type by its id.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param typeId The id of the authenticator type.
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   * @param fields To reduce bandwidth and increase response speeds on slow networks it is possible to request that only partial response models be returned. By specifying a comma separated list of required fields, the response object will restrict the model to only include those fields in the response. These values must exist as part of the object. The id field will always be returned regardless.
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getAuthenticatorType(authorization: string, typeId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'body', reportProgress?: boolean): Observable<AuthenticatorType>;
  public getAuthenticatorType(authorization: string, typeId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AuthenticatorType>>;
  public getAuthenticatorType(authorization: string, typeId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AuthenticatorType>>;
  public getAuthenticatorType(authorization: string, typeId: string, xPreApiFederation?: string, xPreApiVersion?: string, fields?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getAuthenticatorType.');
    }

    if (typeId === null || typeId === undefined) {
      throw new Error('Required parameter typeId was null or undefined when calling getAuthenticatorType.');
    }
    ...
    return this.httpClient.get<AuthenticatorType>(`${this.basePath}/types/${encodeURIComponent(String(typeId))}`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  /**
   * get_authenticator_types
   * Retrieve a collection of authenticator types.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   * @param xPreApiVersion The version of the API endpoint to request. For more information, see the documentation on &#x60;Versioning&#x60;.
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getAuthenticatorTypes(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<AuthenticatorType>>;
  public getAuthenticatorTypes(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<AuthenticatorType>>>;
  public getAuthenticatorTypes(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<AuthenticatorType>>>;
  public getAuthenticatorTypes(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getAuthenticatorTypes.');
    }
    ...
    return this.httpClient.get<Array<AuthenticatorType>>(`${this.basePath}/types`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getAuthenticators(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Authenticator>>;
  public getAuthenticators(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Authenticator>>>;
  public getAuthenticators(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Authenticator>>>;
  public getAuthenticators(authorization: string, xPreApiFederation?: string, xPreApiVersion?: string, sort?: string, page?: number, perPage?: number, fields?: string, filter?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling getAuthenticators.');
    }
    ...
    return this.httpClient.get<Array<Authenticator>>(`${this.basePath}/authenticators`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * Modify an authenticator. Only supplied properties that differ from the existing will be patched.
   * @param authorization Due to the limitations of the Open API 2 specification, authorization headers are supplied on a per function basis. The acceptable formats for this header are &#x60;Bearer &lt;session_id&gt;&#x60; where &#x60;&lt;session_id&gt;&#x60; is replaced by the session id or &#x60;Digest &lt;api_key_signature&gt;&#x60; where &#x60;&lt;api_key_signature&gt;&#x60; is replaced by the API key signature.
   * @param authenticatorId The id of the authenticator.
   * @param body
   * @param xPreApiFederation If a federation has been established between two accounts the outbound federation id can be used to make a marshalled request to the outbound account. Providing the principal has sufficient privileges to invoke the federation, the roles established by the inbound federation will be granted for the request.
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public modifyAuthenticator(authorization: string, authenticatorId: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Authenticator>;
  public modifyAuthenticator(authorization: string, authenticatorId: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Authenticator>>;
  public modifyAuthenticator(authorization: string, authenticatorId: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Authenticator>>;
  public modifyAuthenticator(authorization: string, authenticatorId: string, body: Authenticator, xPreApiFederation?: string, xPreApiVersion?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {

    if (authorization === null || authorization === undefined) {
      throw new Error('Required parameter authorization was null or undefined when calling modifyAuthenticator.');
    }

    if (authenticatorId === null || authenticatorId === undefined) {
      throw new Error('Required parameter authenticatorId was null or undefined when calling modifyAuthenticator.');
    }

    if (body === null || body === undefined) {
      throw new Error('Required parameter body was null or undefined when calling modifyAuthenticator.');
    }
    ...
    return this.httpClient.patch<Authenticator>(`${this.basePath}/authenticators/${encodeURIComponent(String(authenticatorId))}`,
      body,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
